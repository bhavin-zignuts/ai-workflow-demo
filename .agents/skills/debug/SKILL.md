...
name: debug
description: >-
  Systematic root-cause analysis. Reproduce the failure deterministically, identify the cause, hand off a fix hypothesis. Use when triaging a bug before planning a fix.
---
...
1. **Get a deterministic reproduction.** A failing command or a
